                ...
                <Card>
                    <CardHeader>
                        <Link href="/" className="text-4xl font-black leading-relaxed tracking-tighter">
                            Project-Kanban<span className="text-red-500">.</span>
                        </Link>
                            ...
                            <form className="space-y-6" onSubmit={submit}>
                                ...
                                <div className="mt-4 flex items-center justify-between">
                                    ...
                                    <Link
                                        ...
                                        method="post"
                                        as="button"
                                        className="rounded-md text-sm text-muted-foreground underline hover:text-foreground focus:outline-0 focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
                                    >
                                        Logout
                                    </Link>
                                </div>
